	...
	public static void Update()
	{
		...
		if (IsTesting && FinishedWithTest())
		{
			...
			if (testIndex >= allTests.Count || TestSingle)
			{
				...
				{
                    Log.Warn("==============================================");
                    Log.Warn(" _______        _               ______    _ _ ");
					Log.Warn("|__   __|      | |        _    |  ____|  (_) |");
					Log.Warn("   | | ___  ___| |_ ___  (_)   | |__ __ _ _| |");
					Log.Warn("   | |/ _ \\/ __| __/ __|       |  __/ _` | | |");
					Log.Warn("   | |  __/\\__ \\ |_\\__ \\  _    | | | (_| | | |");
					Log.Warn("   |_|\\___||___/\\__|___/ (_)   |_|  \\__,_|_|_|");
                    Log.Warn("==============================================");
					Log.Warn("         Pass Count: {0}  Fail Count: {1}     ", testPassCount, testFailCount);
                    Log.Warn("==============================================");
                }
				SK.Quit();
            }
